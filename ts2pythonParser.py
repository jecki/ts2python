...
class ts2pythonGrammar(Grammar):
    ...
    type = Forward()
    types = Forward()
    source_hash__ = "59fa162fbc04f15a85ce5b43e53b5674"
    early_tree_reduction__ = CombinedParser.MERGE_TREETOPS
    disposable__ = re.compile('(?:EOF$|_namespace$|_array_ellipsis$|EXP$|_top_level_literal$|NEG$|_part$|FRAC$|_quoted_identifier$|DOT$|INT$|_top_level_assignment$)')
