# Generated by ts2python version 0.8.2 on 2026-07-30 11:47:06.125026
# compatibility level: Python 3.15 and above
...
source_hash__ = "38ceefe9ea96cbac4c02b9e409904ad6"
...
class Message(TypedDict, total=True, closed=True):
    jsonrpc: str
...
class ResponseError(TypedDict, total=True, closed=True):
...
class CancelParams(TypedDict, total=True, closed=True):
...
class ProgressParams[T](TypedDict, total=True, closed=True):
...
class HoverParams(TypedDict, total=True, closed=True):
    class Position_0(TypedDict, total=True, closed=True):
        line: int
        character: int
    textDocument: str
...
class HoverResult(TypedDict, total=True, closed=True):
    value: str
...
class RegularExpressionsClientCapabilities(TypedDict, total=True, closed=True):
...
class Position(TypedDict, total=True, closed=True):
...
class Range(TypedDict, total=True, closed=True):
...
class TextDocumentItem(TypedDict, total=True, closed=True):
...
class TextDocumentIdentifier(TypedDict, total=True, closed=True):
...
class TextDocumentPositionParams(TypedDict, total=True, closed=True):
...
class RelativePattern(TypedDict, total=True, closed=True):
...
class TextDocumentFilterLanguage_0(TypedDict, total=True, closed=True):
...
class TextDocumentFilterScheme_0(TypedDict, total=True, closed=True):
...
class TextDocumentFilterPattern_0(TypedDict, total=True, closed=True):
...
class StringValue(TypedDict, total=True, closed=True):
...
class TextEdit(TypedDict, total=True, closed=True):
...
class ChangeAnnotation(TypedDict, total=True, closed=True):
...
class SnippetTextEdit(TypedDict, total=True, closed=True):
...
class TextDocumentEdit(TypedDict, total=True, closed=True):
...
class Location(TypedDict, total=True, closed=True):
    uri: DocumentUri
    range: Range
...
class LocationUriOnly_0(TypedDict, total=True, closed=True):
    uri: DocumentUri
...
class LocationLink(TypedDict, total=True, closed=True):
...
class Diagnostic(TypedDict, total=True, closed=True):
...
class DiagnosticRelatedInformation(TypedDict, total=True, closed=True):
...
class CodeDescription(TypedDict, total=True, closed=True):
...
class Command(TypedDict, total=True, closed=True):
...
class MarkupContent(TypedDict, total=True, closed=True):
...
class MarkdownClientCapabilities(TypedDict, total=True, closed=True):
...
class CreateFileOptions(TypedDict, total=True, closed=True):
...
class CreateFile(TypedDict, total=True, closed=True):
...
class RenameFileOptions(TypedDict, total=True, closed=True):
...
class RenameFile(TypedDict, total=True, closed=True):
...
class DeleteFileOptions(TypedDict, total=True, closed=True):
...
class DeleteFile(TypedDict, total=True, closed=True):
...
class WorkspaceEdit(TypedDict, total=True, closed=True):
...
class WorkspaceEditClientCapabilities(TypedDict, total=True, closed=True):
...
class ChangeAnnotationsSupportOptions_0(TypedDict, total=True, closed=True):
...
class WorkDoneProgressBegin(TypedDict, total=True, closed=True):
    kind: Literal["begin"]
...
class WorkDoneProgressReport(TypedDict, total=True, closed=True):
    kind: Literal["report"]
...
class WorkDoneProgressEnd(TypedDict, total=True, closed=True):
    kind: Literal["end"]
...
class WorkDoneProgressParams(TypedDict, total=True, closed=True):

    # An optional token that a server can use to report work done progress.
    workDoneToken: NotRequired[ProgressToken]


class WorkDoneProgressOptions(TypedDict, total=True, closed=True):
...
class PartialResultParams(TypedDict, total=True, closed=True):
...
class ClientInfo_0(TypedDict, total=True, closed=True):
...
class TextDocumentClientCapabilities(TypedDict, total=True, closed=True):
...
class TextDocumentFilterClientCapabilities(TypedDict, total=True, closed=True):
...
class NotebookDocumentClientCapabilities(TypedDict, total=True, closed=True):
...
class ClientCapabilities(TypedDict, total=True, closed=True):
...
class WorkspaceClientCapabilities_0(TypedDict, total=True, closed=True):
...
class FileOperationClientCapabilities(TypedDict, total=True, closed=True):
...
class WindowClientCapabilities(TypedDict, total=True, closed=True):
...
class GeneralClientCapabilities(TypedDict, total=True, closed=True):
...
class StaleRequestSupportOptions_0(TypedDict, total=True, closed=True):
...
class InitializeResult(TypedDict, total=True, closed=True):
...
class ServerInfo_0(TypedDict, total=True, closed=True):
...
class InitializeError(TypedDict, total=True, closed=True):
...
class ServerCapabilities(TypedDict, total=True, closed=True):
...
class WorkspaceOptions_0(TypedDict, total=True, closed=True):
...
class FileOperationOptions(TypedDict, total=True, closed=True):
...
class InitializedParams(TypedDict, total=True, closed=True):
    pass


class Registration(TypedDict, total=True, closed=True):
...
class RegistrationParams(TypedDict, total=True, closed=True):
...
class StaticRegistrationOptions(TypedDict, total=True, closed=True):
...
class TextDocumentRegistrationOptions(TypedDict, total=True, closed=True):
...
class Unregistration(TypedDict, total=True, closed=True):
...
class UnregistrationParams(TypedDict, total=True, closed=True):
...
class SetTraceParams(TypedDict, total=True, closed=True):
...
class LogTraceParams(TypedDict, total=True, closed=True):
...
class TextDocumentSyncOptions(TypedDict, total=True, closed=True):
...
class DidOpenTextDocumentParams(TypedDict, total=True, closed=True):
...
class DidChangeTextDocumentParams(TypedDict, total=True, closed=True):
...
class TextDocumentContentChangePartial_0(TypedDict, total=True, closed=True):
...
class TextDocumentContentChangeWholeDocument_0(TypedDict, total=True, closed=True):
...
class WillSaveTextDocumentParams(TypedDict, total=True, closed=True):
...
class SaveOptions(TypedDict, total=True, closed=True):
...
class DidSaveTextDocumentParams(TypedDict, total=True, closed=True):
...
class DidCloseTextDocumentParams(TypedDict, total=True, closed=True):
...
class TextDocumentSyncClientCapabilities(TypedDict, total=True, closed=True):
...
class NotebookDocument(TypedDict, total=True, closed=True):
...
class NotebookCell(TypedDict, total=True, closed=True):
...
class ExecutionSummary(TypedDict, total=True, closed=True):
...
class NotebookCellTextDocumentFilter(TypedDict, total=True, closed=True):
...
class NotebookDocumentFilterNotebookType_0(TypedDict, total=True, closed=True):
...
class NotebookDocumentFilterScheme_0(TypedDict, total=True, closed=True):
...
class NotebookDocumentFilterPattern_0(TypedDict, total=True, closed=True):
...
class NotebookDocumentSyncClientCapabilities(TypedDict, total=True, closed=True):
...
class NotebookDocumentSyncOptions(TypedDict, total=True, closed=True):
...
class NotebookDocumentFilterWithNotebook_0(TypedDict, total=True, closed=True):
...
class NotebookDocumentFilterWithCells_0(TypedDict, total=True, closed=True):
...
class NotebookCellLanguage_0(TypedDict, total=True, closed=True):
    language: str
...
class DidOpenNotebookDocumentParams(TypedDict, total=True, closed=True):
...
class DidChangeNotebookDocumentParams(TypedDict, total=True, closed=True):
...
class VersionedNotebookDocumentIdentifier(TypedDict, total=True, closed=True):
...
class NotebookDocumentChangeEvent(TypedDict, total=True, closed=True):
...
class NotebookDocumentCellChanges_0(TypedDict, total=True, closed=True):
...
class NotebookDocumentCellChangeStructure_0(TypedDict, total=True, closed=True):
...
class NotebookDocumentCellContentChanges_0(TypedDict, total=True, closed=True):
...
class NotebookCellArrayChange(TypedDict, total=True, closed=True):
...
class DidSaveNotebookDocumentParams(TypedDict, total=True, closed=True):
...
class DidCloseNotebookDocumentParams(TypedDict, total=True, closed=True):
...
class NotebookDocumentIdentifier(TypedDict, total=True, closed=True):
...
class DeclarationClientCapabilities(TypedDict, total=True, closed=True):
...
class DefinitionClientCapabilities(TypedDict, total=True, closed=True):
...
class TypeDefinitionClientCapabilities(TypedDict, total=True, closed=True):
...
class ImplementationClientCapabilities(TypedDict, total=True, closed=True):
...
class ReferenceClientCapabilities(TypedDict, total=True, closed=True):
...
class ReferenceContext(TypedDict, total=True, closed=True):
...
class CallHierarchyClientCapabilities(TypedDict, total=True, closed=True):
...
class CallHierarchyItem(TypedDict, total=True, closed=True):
...
class CallHierarchyIncomingCall(TypedDict, total=True, closed=True):
...
class CallHierarchyOutgoingCall(TypedDict, total=True, closed=True):
...
class TypeHierarchyClientCapabilities_0(TypedDict, total=True, closed=True):
...
class TypeHierarchyItem(TypedDict, total=True, closed=True):
...
class DocumentHighlightClientCapabilities(TypedDict, total=True, closed=True):
...
class DocumentHighlight(TypedDict, total=True, closed=True):
...
class DocumentLinkClientCapabilities(TypedDict, total=True, closed=True):
...
class DocumentLink(TypedDict, total=True, closed=True):
...
class HoverClientCapabilities(TypedDict, total=True, closed=True):
...
class Hover(TypedDict, total=True, closed=True):
...
class MarkedString_1(TypedDict, total=True, closed=True):
    language: str
    value: str
...
class CodeLensClientCapabilities(TypedDict, total=True, closed=True):
...
class ClientCodeLensResolveOptions_0(TypedDict, total=True, closed=True):
...
class CodeLens(TypedDict, total=True, closed=True):
...
class CodeLensWorkspaceClientCapabilities(TypedDict, total=True, closed=True):
...
class FoldingRangeClientCapabilities(TypedDict, total=True, closed=True):
...
class ClientFoldingRangeKindOptions_0(TypedDict, total=True, closed=True):
...
class ClientFoldingRangeOptions_0(TypedDict, total=True, closed=True):
...
class FoldingRange(TypedDict, total=True, closed=True):
...
class FoldingRangeWorkspaceClientCapabilities(TypedDict, total=True, closed=True):
...
class SelectionRangeClientCapabilities(TypedDict, total=True, closed=True):
...
class SelectionRange(TypedDict, total=True, closed=True):
...
class DocumentSymbolClientCapabilities(TypedDict, total=True, closed=True):
...
class ClientSymbolKindOptions_0(TypedDict, total=True, closed=True):
...
class ClientSymbolTagOptions_0(TypedDict, total=True, closed=True):
...
class DocumentSymbol(TypedDict, total=True, closed=True):
...
class SymbolInformation(TypedDict, total=True, closed=True):
...
class SemanticTokensLegend(TypedDict, total=True, closed=True):
...
class SemanticTokensClientCapabilities(TypedDict, total=True, closed=True):
...
class ClientSemanticTokensRequestOptions_0(TypedDict, total=True, closed=True):
    class Range_1(TypedDict, total=True, closed=True):
        pass
...
class ClientSemanticTokensRequestFullDelta_0(TypedDict, total=True, closed=True):
...
class SemanticTokensFullDelta_0(TypedDict, total=True, closed=True):
...
class SemanticTokens(TypedDict, total=True, closed=True):
...
class SemanticTokensPartialResult(TypedDict, total=True, closed=True):
    data: List[int]
...
class SemanticTokensDelta(TypedDict, total=True, closed=True):
...
class SemanticTokensEdit(TypedDict, total=True, closed=True):
...
class SemanticTokensDeltaPartialResult(TypedDict, total=True, closed=True):
    edits: List[SemanticTokensEdit]
...
class SemanticTokensWorkspaceClientCapabilities(TypedDict, total=True, closed=True):
...
class InlayHintClientCapabilities(TypedDict, total=True, closed=True):
...
class ClientInlayHintResolveOptions_0(TypedDict, total=True, closed=True):
...
class InlayHint(TypedDict, total=True, closed=True):
...
class InlayHintLabelPart(TypedDict, total=True, closed=True):
...
class InlayHintWorkspaceClientCapabilities(TypedDict, total=True, closed=True):
...
class InlineValueClientCapabilities(TypedDict, total=True, closed=True):
...
class InlineValueContext(TypedDict, total=True, closed=True):
...
class InlineValueText(TypedDict, total=True, closed=True):
...
class InlineValueVariableLookup(TypedDict, total=True, closed=True):
...
class InlineValueEvaluatableExpression(TypedDict, total=True, closed=True):
...
class InlineValueWorkspaceClientCapabilities(TypedDict, total=True, closed=True):
...
class MonikerClientCapabilities(TypedDict, total=True, closed=True):
...
class Moniker(TypedDict, total=True, closed=True):
...
class CompletionClientCapabilities(TypedDict, total=True, closed=True):
...
class ClientCompletionItemOptions_0(TypedDict, total=True, closed=True):
...
class CompletionItemTagOptions_0(TypedDict, total=True, closed=True):

    # The tags supported by the client.
    valueSet: List[CompletionItemTag]
type CompletionItemTagOptions = CompletionItemTagOptions_0

class ClientCompletionItemResolveOptions_0(TypedDict, total=True, closed=True):

    # The properties that a client can resolve lazily.
    properties: List[str]
type ClientCompletionItemResolveOptions = ClientCompletionItemResolveOptions_0

class ClientCompletionItemInsertTextModeOptions_0(TypedDict, total=True, closed=True):
    valueSet: List[InsertTextMode]
type ClientCompletionItemInsertTextModeOptions = ClientCompletionItemInsertTextModeOptions_0

class ClientCompletionItemOptionsKind_0(TypedDict, total=True, closed=True):
...
class CompletionListCapabilities(TypedDict, total=True, closed=True):
...
class ServerCompletionItemOptions_0(TypedDict, total=True, closed=True):
...
class CompletionContext(TypedDict, total=True, closed=True):
...
class EditRangeWithInsertReplace_0(TypedDict, total=True, closed=True):
    insert: Range
    replace: Range
...
class CompletionList(TypedDict, total=True, closed=True):
...
class CompletionItemDefaults(TypedDict, total=True, closed=True):
...
class CompletionItemApplyKinds(TypedDict, total=True, closed=True):
...
class InsertReplaceEdit(TypedDict, total=True, closed=True):
...
class CompletionItemLabelDetails(TypedDict, total=True, closed=True):
...
class CompletionItem(TypedDict, total=True, closed=True):
...
class PublishDiagnosticsClientCapabilities(TypedDict, total=True, closed=True):
...
class ClientDiagnosticsTagOptions_0(TypedDict, total=True, closed=True):
...
class PublishDiagnosticsParams(TypedDict, total=True, closed=True):
...
class DiagnosticClientCapabilities(TypedDict, total=True, closed=True):
...
class FullDocumentDiagnosticReport(TypedDict, total=True, closed=True):
...
class UnchangedDocumentDiagnosticReport(TypedDict, total=True, closed=True):
...
class DocumentDiagnosticReportPartialResult(TypedDict, total=True, closed=True):
...
class DiagnosticServerCancellationData(TypedDict, total=True, closed=True):
...
class PreviousResultId(TypedDict, total=True, closed=True):
...
class WorkspaceDiagnosticReport(TypedDict, total=True, closed=True):
...
class WorkspaceDiagnosticReportPartialResult(TypedDict, total=True, closed=True):
    items: List[WorkspaceDocumentDiagnosticReport]
...
class DiagnosticWorkspaceClientCapabilities(TypedDict, total=True, closed=True):
...
class SignatureHelpClientCapabilities(TypedDict, total=True, closed=True):
...
class ClientSignatureInformationOptions_0(TypedDict, total=True, closed=True):
...
class ClientSignatureParameterInformationOptions_0(TypedDict, total=True, closed=True):
...
class SignatureHelpContext(TypedDict, total=True, closed=True):
...
class SignatureHelp(TypedDict, total=True, closed=True):
...
class SignatureInformation(TypedDict, total=True, closed=True):
...
class ParameterInformation(TypedDict, total=True, closed=True):
...
class CodeActionClientCapabilities(TypedDict, total=True, closed=True):
...
class ClientCodeActionLiteralOptions_0(TypedDict, total=True, closed=True):
...
class ClientCodeActionKindOptions_0(TypedDict, total=True, closed=True):
...
class ClientCodeActionResolveOptions_0(TypedDict, total=True, closed=True):

    # The properties that a client can resolve lazily.
    properties: List[str]
type ClientCodeActionResolveOptions = ClientCodeActionResolveOptions_0

class CodeActionTagOptions_0(TypedDict, total=True, closed=True):
...
class CodeActionKindDocumentation(TypedDict, total=True, closed=True):
...
class CodeActionContext(TypedDict, total=True, closed=True):
...
class CodeActionDisabled(TypedDict, total=True, closed=True):
...
class CodeAction(TypedDict, total=True, closed=True):
...
class DocumentColorClientCapabilities(TypedDict, total=True, closed=True):
...
class ColorInformation(TypedDict, total=True, closed=True):
...
class Color(TypedDict, total=True, closed=True):
...
class ColorPresentation(TypedDict, total=True, closed=True):
...
class DocumentFormattingClientCapabilities(TypedDict, total=True, closed=True):
...
class FormattingOptions(TypedDict, total=True, extra_items=bool | int | str):
...
class DocumentRangeFormattingClientCapabilities(TypedDict, total=True, closed=True):
...
class DocumentOnTypeFormattingClientCapabilities(TypedDict, total=True, closed=True):

    # Whether on type formatting supports dynamic registration.
    dynamicRegistration: NotRequired[bool]


class DocumentOnTypeFormattingOptions(TypedDict, total=True, closed=True):
...
class DocumentOnTypeFormattingParams(TypedDict, total=True, closed=True):
...
class RenameClientCapabilities(TypedDict, total=True, closed=True):
...
class PrepareRenamePlaceholder_0(TypedDict, total=True, closed=True):
    range: Range
    placeholder: str
type PrepareRenamePlaceholder = PrepareRenamePlaceholder_0

class PrepareRenameDefaultBehavior_0(TypedDict, total=True, closed=True):
...
class LinkedEditingRangeClientCapabilities(TypedDict, total=True, closed=True):
...
class LinkedEditingRanges(TypedDict, total=True, closed=True):
...
class InlineCompletionClientCapabilities(TypedDict, total=True, closed=True):
...
class InlineCompletionContext(TypedDict, total=True, closed=True):
...
class SelectedCompletionInfo(TypedDict, total=True, closed=True):
...
class InlineCompletionList(TypedDict, total=True, closed=True):
...
class InlineCompletionItem(TypedDict, total=True, closed=True):
...
class WorkspaceSymbolClientCapabilities(TypedDict, total=True, closed=True):
...
class ClientSymbolResolveOptions_0(TypedDict, total=True, closed=True):
...
class WorkspaceSymbol(TypedDict, total=True, closed=True):
...
class ConfigurationParams(TypedDict, total=True, closed=True):
    items: List[ConfigurationItem]


class ConfigurationItem(TypedDict, total=True, closed=True):
...
class DidChangeConfigurationClientCapabilities(TypedDict, total=True, closed=True):
...
class DidChangeConfigurationParams(TypedDict, total=True, closed=True):
...
class WorkspaceFoldersServerCapabilities(TypedDict, total=True, closed=True):
...
class WorkspaceFolder(TypedDict, total=True, closed=True):
...
class DidChangeWorkspaceFoldersParams(TypedDict, total=True, closed=True):
...
class WorkspaceFoldersChangeEvent(TypedDict, total=True, closed=True):
...
class FileOperationRegistrationOptions(TypedDict, total=True, closed=True):
...
class FileOperationPatternOptions(TypedDict, total=True, closed=True):
...
class FileOperationPattern(TypedDict, total=True, closed=True):
...
class FileOperationFilter(TypedDict, total=True, closed=True):
...
class CreateFilesParams(TypedDict, total=True, closed=True):
...
class FileCreate(TypedDict, total=True, closed=True):
...
class RenameFilesParams(TypedDict, total=True, closed=True):
...
class FileRename(TypedDict, total=True, closed=True):
...
class DeleteFilesParams(TypedDict, total=True, closed=True):
...
class FileDelete(TypedDict, total=True, closed=True):
...
class DidChangeWatchedFilesClientCapabilities(TypedDict, total=True, closed=True):
...
class DidChangeWatchedFilesRegistrationOptions(TypedDict, total=True, closed=True):

    # The watchers to register.
    watchers: List[FileSystemWatcher]


class FileSystemWatcher(TypedDict, total=True, closed=True):
...
class DidChangeWatchedFilesParams(TypedDict, total=True, closed=True):
...
class FileEvent(TypedDict, total=True, closed=True):
...
class ExecuteCommandClientCapabilities(TypedDict, total=True, closed=True):
...
class ApplyWorkspaceEditParams(TypedDict, total=True, closed=True):
...
class WorkspaceEditMetadata(TypedDict, total=True, closed=True):

    # Signal to the editor that this edit is a refactoring.
    isRefactoring: NotRequired[bool]


class ApplyWorkspaceEditResult(TypedDict, total=True, closed=True):
...
class TextDocumentContentClientCapabilities_0(TypedDict, total=True, closed=True):
...
class TextDocumentContentOptions_0(TypedDict, total=True, closed=True):
...
class TextDocumentContentParams(TypedDict, total=True, closed=True):
...
class TextDocumentContentResult(TypedDict, total=True, closed=True):
...
class TextDocumentContentRefreshParams(TypedDict, total=True, closed=True):
...
class ShowMessageParams(TypedDict, total=True, closed=True):
...
class ShowMessageRequestClientCapabilities(TypedDict, total=True, closed=True):

    # Capabilities specific to the `MessageActionItem` type.
    messageActionItem: NotRequired[ClientShowMessageActionItemOptions]

class ClientShowMessageActionItemOptions_0(TypedDict, total=True, closed=True):
...
class ShowMessageRequestParams(TypedDict, total=True, closed=True):
...
class MessageActionItem(TypedDict, total=True, extra_items=str | bool | int | Dict):
...
class ShowDocumentClientCapabilities(TypedDict, total=True, closed=True):
...
class ShowDocumentParams(TypedDict, total=True, closed=True):
...
class ShowDocumentResult(TypedDict, total=True, closed=True):
...
class LogMessageParams(TypedDict, total=True, closed=True):
...
class WorkDoneProgressCreateParams(TypedDict, total=True, closed=True):
...
class WorkDoneProgressCancelParams(TypedDict, total=True, closed=True):
