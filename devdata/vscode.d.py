# Generated by ts2python on 2022-10-23 21:24:15.697364
...
source_hash__ = "34ec60f947d23b709d2761707c515169 edbbae7bb1844688136c621f463fad4c"
...
class DiagnosticCollection:
    ...
    set.register
    def _(self, uri: Uri, diagnostics: Union[List[Diagnostic], None]) -> None:
        pass
...
class TextDocumentWillSaveEvent:
    ...
    waitUntil.register
    def _(self, thenable: Coroutine[List[TextEdit]]) -> None:
        pass
...
class FileWillCreateEvent:
    ...
    waitUntil.register
    def _(self, thenable: Coroutine[WorkspaceEdit]) -> None:
        pass
...
class Thenable(Generic[T]):
    ...
    singledispatchmethod
    def then(self, arg1) -> Coroutine[TResult]:
        raise TypeError(f'First argument {arg1} of single-dispatch function/method {name} has illegal type {type(arg1)}')

    TResult = TypeVar('TResult')
    then.register
    def _(self, onfulfilled: Optional[Callable[[T], Union[TResult, Coroutine[TResult]]]] = None, onrejected: Optional[Callable[[Any], Union[TResult, Coroutine[TResult]]]] = None) -> Coroutine[TResult]:
        pass
