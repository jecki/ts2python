# Generated by ts2python version 0.8.2 on 2026-07-19 22:51:37.433272
...
source_hash__ = "eb301483dba5ffd2049dc70d5b2bd5c6"
...
class NotebookDocumentFilter_2(TypedDict):
    ...
    pattern: GlobPattern
    """A glob pattern."""
type NotebookDocumentFilter = NotebookDocumentFilter_0 | NotebookDocumentFilter_1 | NotebookDocumentFilter_2
...
class NotebookDocumentSyncOptions(TypedDict):
    ...
    @since 3.17.0"""
    notebookSelector: List[NotebookSelector_0 | NotebookSelector_1]
...
class CompletionList(TypedDict):
    class ItemDefaults_0(TypedDict):
        ...
        @since 3.17.0"""
        editRange: NotRequired[Range | EditRange_1]
