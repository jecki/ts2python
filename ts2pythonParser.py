...
class ts2pythonGrammar(Grammar):
    ...
    type = Forward()
    types = Forward()
    source_hash__ = "d2ade19afd4a06d9f12bb17dce3f4369"
    early_tree_reduction__ = CombinedParser.MERGE_TREETOPS
    disposable__ = re.compile('(?:DOT$|_namespace$|_top_level_literal$|_array_ellipsis$|_part$|_top_level_assignment$|_quoted_identifier$|FRAC$|EOF$|EXP$|NEG$|INT$)')
