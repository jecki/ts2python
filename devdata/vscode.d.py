# Generated by ts2python on 2022-03-26 22:20:44.449409
...
source_hash__ = "34ec60f947d23b709d2761707c515169 ba48d3a8f0fb9c49eb9de449ade84eb2"
...
class TextDocument:
    ...
    def lineAt1(self, position: 'Position') -> TextLine:
        pass
...
class Position:
    class Translate1Change_0(TypedDict, total=False):
        lineDelta: Optional[float]
        characterDelta: Optional[float]
    class With_1Change_0(TypedDict, total=False):
        line: Optional[float]
    ...
    def translate1(self, change: Translate1Change_0) -> 'Position':
        pass
    
    def with_(self, line: Optional[float] = None, character: Optional[float] = None) -> 'Position':
        pass
    
    def with_1(self, change: With_1Change_0) -> 'Position':
        pass
...
class Range:
    ...
    def constructor1(self, startLine: float, startCharacter: float, endLine: float, endCharacter: float) -> Any:
        pass
    isEmpty: bool
    isSingleLine: bool
    ...
    def with_1(self, change: With_1Change_0) -> 'Range':
        pass
...
class Selection(Range):
    ...
    def constructor1(self, anchorLine: float, anchorCharacter: float, activeLine: float, activeCharacter: float) -> Any:
        pass
    isReversed: bool
...
class SymbolInformation:
    ...
    def constructor1(self, name: str, kind: SymbolKind, range: Range, uri: Optional[Uri] = None, containerName: Optional[str] = None) -> Any:
        pass
...
class SemanticTokensBuilder:
    ...
    def push1(self, range: Range, tokenType: str, tokenModifiers: Optional[List[str]] = None) -> None:
        pass
...
class WorkspaceConfiguration:
    ...
    def get1(self, section: str, defaultValue: T) -> T:
        pass
...
class DiagnosticCollection:
    ...
    def set1(self, entries: List[Tuple[Uri, Union[List[Diagnostic], None]]]) -> None:
        pass
...
class OutputChannel:
    ...
    def show1(self, column: Optional[ViewColumn] = None, preserveFocus: Optional[bool] = None) -> None:
        pass
...
class Memento:
    ...
    def get1(self, key: str, defaultValue: T) -> T:
        pass
...
class ProcessExecution:
    ...
    def constructor1(self, process: str, args: List[str], options: Optional[ProcessExecutionOptions] = None) -> Any:
        pass
    process: str
    args: List[str]
...
class ShellExecution:
    ...
    def constructor1(self, command: Union[str, ShellQuotedString], args: List[Union[str, ShellQuotedString]], options: Optional[ShellExecutionOptions] = None) -> Any:
        pass
...
class Task:
    ...
    def constructor1(self, taskDefinition: TaskDefinition, name: str, source: str, execution: Optional[Union[ProcessExecution, ShellExecution]] = None, problemMatchers: Optional[Union[str, List[str]]] = None) -> Any:
        pass
...
class window:
    ...
    def showTextDocument1(document: TextDocument, options: Optional[TextDocumentShowOptions] = None) -> Coroutine[TextEditor]:
        pass
    
    def showTextDocument2(uri: Uri, options: Optional[TextDocumentShowOptions] = None) -> Coroutine[TextEditor]:
        pass
    ...
    def showInformationMessage1(message: str, options: MessageOptions, *items: T) -> Coroutine[Union[T, None]]:
        pass
    T = TypeVar('T')
    
    def showInformationMessage2(message: str, *items: T) -> Coroutine[Union[T, None]]:
        pass
    T = TypeVar('T')
    
    def showInformationMessage3(message: str, options: MessageOptions, *items: T) -> Coroutine[Union[T, None]]:
        pass
    T = TypeVar('T')
    ...
    def showWarningMessage1(message: str, options: MessageOptions, *items: T) -> Coroutine[Union[T, None]]:
        pass
    T = TypeVar('T')
    
    def showWarningMessage2(message: str, *items: T) -> Coroutine[Union[T, None]]:
        pass
    T = TypeVar('T')
    
    def showWarningMessage3(message: str, options: MessageOptions, *items: T) -> Coroutine[Union[T, None]]:
        pass
    T = TypeVar('T')
    ...
    def showErrorMessage1(message: str, options: MessageOptions, *items: T) -> Coroutine[Union[T, None]]:
        pass
    T = TypeVar('T')
    
    def showErrorMessage2(message: str, *items: T) -> Coroutine[Union[T, None]]:
        pass
    T = TypeVar('T')
    
    def showErrorMessage3(message: str, options: MessageOptions, *items: T) -> Coroutine[Union[T, None]]:
        pass
    ...
    def showQuickPick1(items: Union[List[str], Coroutine[List[str]]], options: Optional[QuickPickOptions] = None, token: Optional[CancellationToken] = None) -> Coroutine[Union[str, None]]:
        pass
    T = TypeVar('T')
    
    def showQuickPick2(items: Union[List[T], Coroutine[List[T]]], options: Any, token: Optional[CancellationToken] = None) -> Coroutine[Union[List[T], None]]:
        pass
    T = TypeVar('T')
    
    def showQuickPick3(items: Union[List[T], Coroutine[List[T]]], options: Optional[QuickPickOptions] = None, token: Optional[CancellationToken] = None) -> Coroutine[Union[T, None]]:
        pass
    ...
    def setStatusBarMessage1(text: str, hideWhenDone: Coroutine[Any]) -> Disposable:
        pass
    
    def setStatusBarMessage2(text: str) -> Disposable:
        pass
    R = TypeVar('R')
    ...
    def createStatusBarItem1(id: str, alignment: Optional[StatusBarAlignment] = None, priority: Optional[float] = None) -> StatusBarItem:
        pass
    ...
    def createTerminal1(options: 'TerminalOptions') -> Terminal:
        pass
    
    def createTerminal2(options: 'ExtensionTerminalOptions') -> Terminal:
        pass
    T = TypeVar('T')
...
class TreeItem:
    ...
    def constructor1(self, resourceUri: Uri, collapsibleState: Optional['TreeItemCollapsibleState'] = None) -> Any:
        pass
...
class TextDocumentWillSaveEvent:
    ...
    def waitUntil1(self, thenable: Coroutine[Any]) -> None:
        pass
...
class workspace:
    ...
    def openTextDocument1(fileName: str) -> Coroutine[TextDocument]:
        pass
    
    def openTextDocument2(options: Optional[OpenTextDocument2Options_0] = None) -> Coroutine[TextDocument]:
        pass
    ...
    def openNotebookDocument1(notebookType: str, content: Optional['NotebookData'] = None) -> Coroutine['NotebookDocument']:
        pass
...
class languages:
    ...
    def getDiagnostics1() -> List[Tuple[Uri, List[Diagnostic]]]:
        pass
    ...
    def registerSignatureHelpProvider1(selector: DocumentSelector, provider: SignatureHelpProvider, metadata: SignatureHelpProviderMetadata) -> Disposable:
        pass
...
class authentication:
    ...
    def getSession1(providerId: str, scopes: List[str], options: Any) -> Coroutine[AuthenticationSession]:
        pass
    
    def getSession2(providerId: str, scopes: List[str], options: Optional[AuthenticationGetSessionOptions] = None) -> Coroutine[Union[AuthenticationSession, None]]:
        pass
...
class Thenable(Generic[T]):
    ...
    def then1(self, onfulfilled: Optional[Callable[[T], Union[TResult, Coroutine[TResult]]]] = None, onrejected: Optional[Callable[[Any], None]] = None) -> Coroutine[TResult]:
        pass
