# Generated by ts2python on 2022-02-24 12:14:25.584671
...
source_hash__ = "34ec60f947d23b709d2761707c515169 b67e1ff324cc313c1fac4666c3edbb42"
...
class Event(Generic[T], ):
    pass  # Transpiling function definitions has not yet been implemented: anonymous() ignored!
...
DocumentSelector = Union[DocumentFilter, str, ReadonlyArray[Union[DocumentFilter, str]]]


ProviderResult = Union[T, undefined, None, Thenable[Union[T, undefined, None]]]
...
class CodeActionProviderMetadata(TypedDict, total=False):
    ...
    documentation: Optional['ReadonlyArray'[Documentation_0]]
...
class CodeLensProvider(Generic[T], ):
    onDidChangeCodeLenses: Optional[Event[None]]
...
class InlineValuesProvider():
    onDidChangeInlineValues: Union[Event[None], 'undefined']
...
class DocumentSemanticTokensProvider():
    onDidChangeSemanticTokens: Optional[Event[None]]
...
class InlayHintsProvider(Generic[T], ):
    onDidChangeInlayHints: Optional[Event[None]]
...
class FoldingRangeProvider():
    onDidChangeFoldingRanges: Optional[Event[None]]
...
class Terminal():
    name: str
    processId: 'Thenable'[Union[float, 'undefined']]
...
class ExtensionContext():
    class Subscriptions_0(TypedDict, total=True):
        pass  # Transpiling function definitions has not yet been implemented: dispose() ignored!
    subscriptions: List[Subscriptions_0]
...
class TreeDataProvider(Generic[T], ):
    onDidChangeTreeData: Optional[Event[Union[T, 'undefined', None]]]
...
class NotebookController():
    ...
    executeHandler: Callable[[List[NotebookCell], NotebookDocument, 'NotebookController'], Union[None, 'Thenable'[None]]]
    interruptHandler: Optional[Callable[[NotebookDocument], Union[None, 'Thenable'[None]]]]
...
class NotebookCellStatusBarItemProvider():
    onDidChangeCellStatusBarItems: Optional[Event[None]]
...
class CommentController():
    ...
    reactionHandler: Optional[Callable[[Comment, CommentReaction], 'Thenable'[None]]]
    pass  # Transpiling function definitions has not yet been implemented: dispose() ignored!
...
class TestRunProfile():
    ...
    runHandler: Callable[['TestRunRequest', CancellationToken], Union['Thenable'[None], None]]
    pass  # Transpiling function definitions has not yet been implemented: dispose() ignored!
...
class TestController():
    ...
    resolveHandler: Optional[Callable[[Union['TestItem', 'undefined']], Union['Thenable'[None], None]]]
    refreshHandler: Union[Callable[[CancellationToken], Union['Thenable'[None], None]], 'undefined']
