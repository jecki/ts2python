# Generated by ts2python version 0.8.0 on 2025-08-11 20:11:29.288375
...
source_hash__ = "a3c0b8e6aca9823a389faf40bc6eb21e"
...
class WebviewPanel:
    ...
    iconPath: Optional[Union[Uri, IconPath_1]]
...
# Event fired when a webview panelʼs view state changes.
...
class WebviewViewResolveContext(Generic[T], GenericTypedDict):
    ...
    # `WebviewView` itself is kept alive but the webviewʼs underlying document is deallocated. It is recreated when
    # the view becomes visible again.

    # You can prevent this behavior by setting `retainContextWhenHidden` in the `WebviewOptions`. However this
    # increases resource usage and should be avoided wherever possible. Instead, you can use persisted state to
    # save off a webviewʼs state so that it can be quickly recreated as needed.
...
class CustomDocumentEditEvent(Generic[T]):
    ...
    # edit was added to the editorʼs internal edit stack by `onDidChangeCustomDocument`.
...
class CustomEditorProvider(CustomReadonlyEditorProvider[T], Generic[T]):
    ...
    # Editors that support editing but cannot use the editorʼs standard undo/redo mechanism must fire a `CustomDocumentContentChangeEvent`.
...
# It is up to the extension to decide whether to accept the userʼs input
...
class QuickInputButtons:
    ...
    # When a navigation ʼbackʼ button is needed this one should be used for consistency.
...
class workspace:
    ...
    def _(uri: Uri) -> Thenable[TextDocument]:
        pass
    ...
    @openTextDocument.register
    def _(path: str) -> Thenable[TextDocument]:
        pass
...
class authentication:
    ...
    @getSession.register
    def _(providerId: str, scopes: ReadOnly[List[str]], options: Any) -> Thenable[AuthenticationSession]:
        pass
    ...
    @getSession.register
    def _(providerId: str, scopes: ReadOnly[List[str]], options: Optional[AuthenticationGetSessionOptions] = None) -> Thenable[Union[AuthenticationSession, None]]:
        pass
...
class l10n:
    class TOptions_0(TypedDict):
        ...
        args: NotRequired[Union[List[Union[str, float, bool]], Dict[str, Any]]]
    ...
    @t.register
    def _(message: str, args: Dict[str, Any]) -> str:
        pass
...
class LanguageModelChatMessage:
    ...
    def User(self, content: Union[str, List[Union[LanguageModelTextPart, LanguageModelToolResultPart]]], name: Optional[str] = None) -> LanguageModelChatMessage:
        pass
    ...
    def Assistant(self, content: Union[str, List[Union[LanguageModelTextPart, LanguageModelToolCallPart]]], name: Optional[str] = None) -> LanguageModelChatMessage:
        pass
    ...
    content: List[Union[LanguageModelTextPart, LanguageModelToolResultPart, LanguageModelToolCallPart]]
...
class LanguageModelChatResponse(TypedDict):
    ...
    # }
    # ```
    stream: AsyncIterable[Union[LanguageModelTextPart, LanguageModelToolCallPart, Any]]
...
class LanguageModelToolResultPart:
    ...
    content: List[Union[LanguageModelTextPart, LanguageModelPromptTsxPart, Any]]
