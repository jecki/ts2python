...
class ts2pythonGrammar(Grammar):
    ...
    disposable__ = re.compile('(?:NEG$|_namespace$|DOT$|_quoted_identifier$|EXP$|FRAC$|_top_level_literal$|EOF$|_reserved$|_top_level_assignment$|INT$|_array_ellipsis$|_part$|_keyword$)')
